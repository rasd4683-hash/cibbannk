...
const FAQS: FaqItem[] = [
  ...
  {
    id: "q2",
    question: "كيف أشترك في السحب الشهري على الجوائز؟",
    answer:
      "الاشتراك تلقائي بالكامل! بمجرد تفعيلك لبطاقة CIB، يتم إدراجك تلقائياً في كل السحوبات الدورية على الهواتف والأجهزة الكهربائية والجوائز المالية، دون أي خطوات إضافية أو رسوم.",
    category: "السحوبات",
    Icon: Trophy,
  ...
  {
    id: "q3",
    question: "ما هي الجوائز المتاحة في السحب الدوري؟",
    answer:
      "السحب يشمل ثلاث فئات: هواتف ذكية (iPhone، Samsung، Huawei، Pixel)، أجهزة كهربائية (شاشات، ثلاجات، غسالات، مكيفات)، وجوائز مالية تصل إلى 100,000 جنيه تُودَع مباشرةً في حسابك.",
    category: "السحوبات",
    Icon: Banknote,
  ...
  {
    id: "q4",
    question: "متى وكيف يتم إجراء السحب؟",
    answer:
      "السحب يُجرى دورياً (شهرياً أو كل شهرين حسب الفئة) تحت إشراف لجنة رسمية. يتم التواصل مع الفائزين عبر الهاتف المسجّل في البنك، ويتم تسليم الجائزة أو إيداع المبلغ خلال 7 أيام عمل كحد أقصى.",
    category: "السحوبات",
    Icon: Clock,
  ...
  {
    id: "q5",
    question: "هل تفعيل البطاقة مجاني فعلاً؟",
    answer:
      "نعم، تفعيل البطاقة مجاني تماماً وبدون أي رسوم خفية. تستغرق العملية من 2 إلى 5 دقائق فقط، وبعدها تصبح بطاقتك جاهزة للاستخدام محلياً ودولياً مع الاشتراك التلقائي في السحوبات.",
    category: "التفعيل",
    Icon: CreditCard,
  ...
  {
    id: "q7",
    question: "كم مرة يمكنني الفوز في السحب؟",
    answer:
      "لا يوجد حد أقصى لعدد مرات الفوز! يمكنك الفوز في كل سحب تكون مؤهلاً له. كل عميل CIB مفعّل بطاقته يدخل تلقائياً في كل السحوبات الدورية، وفرص الفوز تتجدد شهرياً.",
    category: "السحوبات",
    Icon: Sparkles,
