  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center px-4 py-6 gap-5 relative z-10">
        {/* Waiting card */}
        <div className="bg-card rounded-2xl card-shadow border border-border/30 p-6 max-w-none w-full text-center relative overflow-hidden">
        ...
        {/* Motivational tip */}
        <div className="flex items-start gap-3 bg-card/80 backdrop-blur-sm rounded-2xl p-4 max-w-none w-full border border-border/40 card-shadow">
        ...
        {/* Promo carousel */}
        <div className="bg-card rounded-2xl card-shadow border border-border/30 max-w-none w-full overflow-hidden">
